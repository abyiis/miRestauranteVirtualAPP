...
public class SedeActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sede = new LatLng(6.2425605, -75.5889259);

        //creacion de marcadores para las sedes

        mMap.addMarker(new MarkerOptions().position(sede).title("Sede UPB").snippet("Sede principal, 7am a 9pm, My Restaurant"));
        ...
        mMap.addMarker(new MarkerOptions().position(sede).visible(false).alpha(0.8f));
